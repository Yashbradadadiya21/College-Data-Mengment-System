...
for(i=0;choice!='n'&& choice!='N';i++)
{
 ...
 if((choice=='y')||(choice=='Y')||(choice=='1'))
 {
  ...
  t1<<tech[i].fst_name<<endl<<tech[i].lst_name<<endl<<tech[i].qualification<<endl<<tech[i].exp<<endl<<tech[i].serves<<endl<<tech[i].subj<<endl<<tech[i].lec<<endl<<tech[i].pay<<endl<<tech[i].addrs<<endl<<tech[i].cel_no<<endl<<tech[i].blod_grp<<endl;
  cout<<"\n\n\t\t\t\t\tDo you want to enter data: ";
  cin>>choice;
 }//if
}//for loop
